...
<div class="container-fluid px-4 pt-4">
            ...
            <div class="card card-statistic shadow-sm border-0 h-100">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="h2 mb-0 fw-bold">{{ isset($outlierData) ? count(json_decode($outlierData)) : 'N/A' }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    @auth
        @if(auth()->user()->role === 'user' && auth()->user()->company)
            @php
                $companyData = collect($statusSummary)->firstWhere('company', auth()->user()->company);
            @endphp
            <h5 class="fw-bold mb-3">Status Kendaraan - {{ auth()->user()->company }}</h5>
            <div class="row">
                <div class="col-md-3 col-sm-6 mb-4">
                    <div class="card shadow-sm border-0 h-100">
                        <div class="card-header d-flex align-items-center">
                            ...
                            <h6 class="mb-0 fw-semibold">{{ auth()->user()->company }}</h6>
                        </div>
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-2 p-2 bg-success bg-opacity-10 rounded">
                                <div class="d-flex align-items-center text-success">
                                ...
                                <span class="fw-bold text-success">{{ $companyData['normal'] ?? 0 }}</span>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2 p-2 bg-primary bg-opacity-10 rounded">
                                <div class="d-flex align-items-center text-primary">
                                    <span class="me-2">
                                ...
                                <span class="fw-bold text-primary">{{ $companyData['refuel'] ?? 0 }}</span>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2 p-2 bg-danger bg-opacity-10 rounded">
                                <div class="d-flex align-items-center text-danger">
                                    <span class="me-2">
                                ...
                                <span class="fw-bold text-danger">{{ $companyData['theft'] ?? 0 }}</span>
                            </div>
                            <div class="d-flex align-items-center justify-content-between p-2 bg-warning bg-opacity-10 rounded">
                                <div class="d-flex align-items-center text-warning">
                                    <span class="me-2">
                                ...
                                <span class="fw-bold text-warning">{{ $companyData['plugged_theft'] ?? 0 }}</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div id="resultSection" class="mt-5" style="display: none;">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <div id="loader">Sedang memuat data...</div>
