...
<head>
  ...
  <meta name="csrf-token" content="{{ csrf_token() }}">
   <link rel="stylesheet" href="{{ asset('PREVIEW-DATA.css') }}">
      ...
      <div class="form-section">
        ...
        <div class="form-row">
         ...
         <div class="button-group">
          <button class="btn btn-primary" id="loadBtn"><i class="fas fa-sync-alt"></i> Load</button> <!-- Simple icon: sync for load -->
          <button class="btn btn-secondary" id="exportBtn"><i class="fas fa-download"></i> Export</button> <!-- Download arrow -->
          <button class="btn btn-warning" id="clearTableBtn"><i class="fas fa-eraser"></i> Clear</button> <!-- Eraser for clear -->
          <button class="btn btn-danger" id="deleteTableBtn"><i class="fas fa-trash"></i> Delete Table</button> <!-- Trash -->
          <button class="btn btn-danger" id="deleteCompanyBtn"><i class="fas fa-trash"></i> Delete Company</button> <!-- Trash (simple, same for consistency) -->
        </div>
      </div>
