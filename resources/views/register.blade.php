...
<head>
    ...
    <title>Portal Tambang - Register</title>
            ...
            <div class="w-full max-w-md">
                <div class="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <p class="text-gray-600">Buat akun untuk akses sistem manajemen</p>
                    </div>
                    ...
                    <form action="{{ route('actionregister') }}" method="POST" class="space-y-6">
                        ...
                        <p class="text-center text-sm text-gray-600 mt-4">
                            Sudah punya akun? 
                            <a href="{{ url('/') }}" class="text-amber-600 hover:text-amber-700 font-medium">Login di sini</a>
                        </p>
                    </form>
